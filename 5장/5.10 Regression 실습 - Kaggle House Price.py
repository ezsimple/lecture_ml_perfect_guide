...
house_df_org = pd.read_csv('./kaggle/house_price.csv')
...
# (중요) 먼저 target값이 skew 되어 있는지 확인하는 게 중요합니다.
...
# * (중요) get_dummies()는 null값을 반영하여 자동 원-핫 인코딩 수행
